...
public class SendServerSidePushToDepartmentUsersByApi {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String department_code = "001027017"; //部门代码
			int send_count = account.pushMessageToAllDepartmentUsers(department_code, message, alert,
					alert_extend);
